...
const AdminLogin = () => {
  const {errMsg,email,setEmail,password, setPassword, handleAdminLogin, isLoading} = useMainContext()
  return (
    <div >
      <Container>
        <Row>
          <div className='mb-2'>
            <p className="h2 w-75 mx-auto text-center text-uppercase">Admin login</p>
          </div>
          ...
          <Col xs={ 10 } md={ 8 } lg={ 6 } className='mx-auto'>
            ...
            <div className='d-flex justify-content-between'>
              ...
              <div className='my-auto'>
                <Button disabled={ isLoading ? true : false } variant='outline-success' onClick={ handleAdminLogin } >
                  { isLoading ? (
                        <>
